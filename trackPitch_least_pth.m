...
%     filterLP1 = design(h, 'ellip', 'SystemObject', true);
    ...
    stopbandatt = 80 ;
    BW = 290;
    SRC1 = dsp.SampleRateConverter('Bandwidth',BW,...
    'InputSampleRate',320,'OutputSampleRate',PLLFs);
    SRC2 = dsp.SampleRateConverter('Bandwidth',BW * 2,...
    'InputSampleRate',640,'OutputSampleRate',PLLFs);
    SRC3 = dsp.SampleRateConverter('Bandwidth',BW * 4,...
    'InputSampleRate',1280,'OutputSampleRate',PLLFs);
    SRC4 = dsp.SampleRateConverter('Bandwidth',BW * 8,...
