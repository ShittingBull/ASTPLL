...
% Calculate the coefficients using the IIRLPNORM function.
    ...
    F = [0 Fpass Fpass+20 Fs_d/2]/(Fs_d/2);
    [b,a,err,sos_var,g] = iirlpnorm(Nb, Na, F, F, [1 1 0 0], [Wpass Wpass ...
    Wstop Wstop], P, {dens});
    filterLP3 = dsp.BiquadFilter( ...
    'Structure', 'Direct form II', ...
    'SOSMatrix', sos_var, ...
    'ScaleValues', g);
    ...
    Fs_d    = Fs/4;
    Fpass = Fs_d / 4;  % Passband Frequency
    F = [0 Fpass Fpass+10 Fs_d/2]/(Fs_d/2);
    [b,a,err,sos_var,g] = iirlpnorm(Nb, Na, F, F, [1 1 0 0], [Wpass Wpass ...
    Wstop Wstop], P, {dens});
    filterLP2 = dsp.BiquadFilter( ...
    'Structure', 'Direct form II', ...
    'SOSMatrix', sos_var, ...
    'ScaleValues', g);
...
%     filterLP1 = design(h, 'ellip', 'SystemObject', true);
    ...
    'InputSampleRate',320,'OutputSampleRate',PLLFs,'StopbandAttenuation',stopbandatt);
    SRC2 = dsp.SampleRateConverter('Bandwidth',620,...
    'InputSampleRate',640,'OutputSampleRate',PLLFs,'StopbandAttenuation',stopbandatt);
    SRC3 = dsp.SampleRateConverter('Bandwidth',1240,...
    'InputSampleRate',1280,'OutputSampleRate',PLLFs,'StopbandAttenuation',stopbandatt);
    SRC4 = dsp.SampleRateConverter('Bandwidth',2480,...
    'InputSampleRate',2560,'OutputSampleRate',PLLFs,'StopbandAttenuation',stopbandatt);
    ...
    [b,a,err,sos_var,g] = iirlpnorm(Nb, Na, F, F, [0 0 1 1], [Wpass Wpass ...
    Wstop Wstop], P, {dens});
    filterHP4 = dsp.BiquadFilter( ...
    'Structure', 'Direct form II', ...
    'SOSMatrix', sos_var, ...
    'ScaleValues', g);
    %filterHP4 = design(h, 'ellip', .. 'SystemObject', true);
  
    Fs_d    = Fs/2;
    Fpass = Fs_d / 4;  % Passband Frequency
    F = [0 Fpass-20  Fpass Fs_d/2]/(Fs_d/2);
    [b,a,err,sos_var,g] = iirlpnorm(Nb, Na, F, F, [0 0 1 1], [Wpass Wpass ...
    Wstop Wstop], P, {dens});
    filterHP3 = dsp.BiquadFilter( ...
    'Structure', 'Direct form II', ...
    'SOSMatrix', sos_var, ...
    'ScaleValues', g);
    
    %filterHP3 = design(h, 'ellip','SystemObject', true);
    Fs_d    = Fs/4;
    Fpass = Fs_d / 4;  % Passband Frequency
   
    F = [0 Fpass-10  Fpass Fs_d/2]/(Fs_d/2);
    [b,a,err,sos_var,g] = iirlpnorm(Nb, Na, F, F, [0 0 1 1], [Wpass Wpass ...
    Wstop Wstop], P, {dens});
    filterHP2 = dsp.BiquadFilter( ...
    'Structure', 'Direct form II', ...
    'SOSMatrix', sos_var, ...
    'ScaleValues', g);
    %filterHP2 = design(h, 'ellip', ... 'SystemObject', true);
    
    Fs_d    = Fs/8;
    Fpass = Fs_d / 4;  % Passband Frequency
    F = [0 Fpass-5  Fpass Fs_d/2]/(Fs_d/2);
    [b,a,err,sos_var,g] = iirlpnorm(Nb, Na, F, F, [0 0 1 1], [Wpass Wpass ...
    Wstop Wstop], P, {dens});
    filterHP1 = dsp.BiquadFilter( ...
    'Structure', 'Direct form II', ...
    'SOSMatrix', sos_var, ...
    'ScaleValues', g);
    %filterHP1 = design(h, 'ellip', 'SystemObject', true);
